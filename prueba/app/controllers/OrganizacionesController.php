...
class OrganizacionesController extends \Phalcon\Mvc\Controller
{
    ...
    public function indexAction()
    {
       ...
       $this->view->setVar("listaOrganizaciones", Organizaciones::find(["cache"=>["key"=>"modelsCache"]]));
    }
    	...
    	{
    		if($infoRecord = Organizaciones::findFirst($id))
    			{
    	...
    	{
    		if($record = Organizaciones::findFirst($id))
    			{
